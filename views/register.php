...
<head>
    ...
    <title>Register- Hogwarts High School</title>
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">Hogwarts High</a>
            </div>
        ...
        <div class="col-xs-12 col-sm-8 col-md-4 col-sm-offset-2 col-md-offset-4">
        	<div class="panel panel-default">
        		<div class="panel-heading">
			    		<h3 class="panel-title">STUDENT REGISTIRATION</h3>
			 			</div>
			    		...
			    		<form role="form">
			    			...
			    			<div class="form-group">
			    				<input type="text" name="reg_no" id="reg_no" class="form-control input-sm" placeholder="Registration Number">
			    			</div>
